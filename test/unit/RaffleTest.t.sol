...
contract RaffleTest is Test {
    ...
    address public PLAYER = makeAddr("player"); // makeAddr is a standard cheat
    ...
    function testCantEnterWhileRaffleIsCalculating() public raffleEnteredAndTimePassed {
    ...
    function testPerformUpkeepCanRunIfCheckUpkeepIsTrue() public raffleEnteredAndTimePassed {
        // Arrange
        ...
        skipFork
    {
        ...
        for (uint256 i = startingIndex; i < startingIndex + additionalEntrances; i++) {
            ...
            hoax(player, STARTING_USER_BALANCE); // deal 1 eth to the player (remember: hoax = prank + deal)
            raffle.enterRaffle{value: entranceFee}();
        }
